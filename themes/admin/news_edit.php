...
$(document).ready(function(){
	...
	var ft = $('#foto').val();
	if (ft != 'default_image' || ft != 'upload_image')
	{
		$('#fotoyuklemealani').hide();
		$('#fotobilgi').show();
		$('#fotobilgi').html('<a href="<?php echo base_url(); ?>' + ft + '" rel="lightbox" title="Ön İzleme [Gerçek Boyut]">fotoğrafa bak</a>');
	}
...
<td class="text">
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="2">
      <tr>
        <td width="12%">ID</td>
        <td width="2%">:</td>
        <td width="86%"><?php echo $haber['id']; ?><input name="news_id" id="news_id" type="hidden" value="<?php echo $haber['id']; ?>" /></td>
      </tr>
      <tr>
        ...
        <td width="86%"><select name="kategori" id="kategori">
			...
			{
				if ($haber['category'] == $c['c_id'])
				{
					echo '<option selected="selected" value="' . $c['c_id'] . '">' . $c['category_name'] . '</option>';
				} else {
      ...
      <tr>
        <td>Başlık</td>
        <td>:</td>
        <td><input name="baslik" id="baslik" style="width:500px;" value="<?php echo  $haber['title']; ?>" type="text" /></td>
      </tr>
      <tr>
        <td>Tarih</td>
        <td>:</td>
        <td><input type="text" name="tarih" id="tarih" style="width:500px;" value="<?php echo date('d.m.Y H:i:s',$haber['date']); ?>" readonly="readonly" /></td>
      </tr>
      <tr>
        <td>Fotoğraf</td>
        <td>:</td>
      ...
      <tr>
        ...
        <td valign="top">:</td>
        <td><textarea name="icerik" cols="" rows=""><?php echo $haber['news_content']; ?></textarea></td>
      </tr>
      <tr>
        <td>Hit</td>
        <td>:</td>
        <td><input name="hit" id="hit" style="width:500px;" value="<?php echo $haber['hit']; ?>" type="text" /></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Yazar</td>
        <td>:</td>
        <td><input name="facebook_name" id="facebook_name" value="<?php echo $haber['news_writer']; ?>" type="text" readonly="readonly" /></td>
      </tr>
      <tr>
        <td>Facebook ID</td>
        <td>:</td>
        <td><input name="facebook_id" id="facebook_id" value="<?php echo $haber['news_writer_facebookid']; ?>" type="text" readonly="readonly" /></td>
      </tr>
      <tr>
        <td>Facebook Email</td>
        <td>:</td>
        <td><input name="facebook_email" id="facebook_email" value="<?php echo $haber['news_writer_email']; ?>" type="text" readonly="readonly" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
